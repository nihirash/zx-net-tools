...
initWifi:
    call loadWiFiConfig : call uartBegin
...
loadWiFiConfig:
    ei
    xor a : ld (CURKEY), a
    ld hl, lbl_ssid : call showTypePrint
    call cleanIBuff : call input
    ld hl, iBuff, de, ssid, bc, 64 : ldir

    ld hl, lbl_pass : call showTypePrint
    call cleanIBuff : call input
    ld hl, iBuff, de, pass, bc, 64 : ldir
